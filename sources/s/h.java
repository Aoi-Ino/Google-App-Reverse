...
public class h extends e {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x001d:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x0028 }
                s.d$b r1 = s.d.b.TOP     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x0033 }
                s.d$b r1 = s.d.b.BOTTOM     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x003e }
                s.d$b r1 = s.d.b.BASELINE     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x0049 }
                s.d$b r1 = s.d.b.CENTER     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x0054 }
                s.d$b r1 = s.d.b.CENTER_X     // Catch:{ NoSuchFieldError -> 0x0054 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
                r2 = 7
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0054 }
            L_0x0054:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x0060 }
                s.d$b r1 = s.d.b.CENTER_Y     // Catch:{ NoSuchFieldError -> 0x0060 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0060 }
                r2 = 8
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0060 }
            L_0x0060:
                int[] r0 = f15797a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: s.h.a.<clinit>():void");
        }
    }
    ...
    public void g(d dVar, boolean z10) {
        ...
        if (fVar != null) {
            ...
            if (this.S0 && this.P0.n()) {
                ...
                dVar.d(p.d.s(dVar, dVar.q(this.P0), dVar.q(o11), this.L0));
            }
        }
    }
