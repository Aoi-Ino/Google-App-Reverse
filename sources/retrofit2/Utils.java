...
final class Utils {
    ...
    static e0 buffer(e0 e0Var) throws IOException {
        e eVar = new e();
        e0Var.source().L(eVar);
        return e0.create(e0Var.contentType(), e0Var.contentLength(), (g) eVar);
    }
    ...
    static RuntimeException methodError(Method method, @Nullable Throwable th2, String str, Object... objArr) {
