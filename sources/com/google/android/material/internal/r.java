...
public abstract class r {
    ...
    private static final int[] f6206a = {b.f14964j};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f6207b = {b.colorPrimaryVariant};

    public static void a(Context context) {
        e(context, f6206a, "Theme.AppCompat");
    }

    private static void b(Context context, AttributeSet attributeSet, int i10, int i11) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, k.f14986b8, i10, i11);
        boolean z10 = obtainStyledAttributes.getBoolean(k.f15006d8, false);
    ...
    public static void c(Context context) {
        e(context, f6207b, "Theme.MaterialComponents");
    }
    ...
    private static void d(Context context, AttributeSet attributeSet, int[] iArr, int i10, int i11, int... iArr2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, k.f14986b8, i10, i11);
        boolean z11 = false;
        if (!obtainStyledAttributes.getBoolean(k.f15016e8, false)) {
            obtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 == null || iArr2.length == 0) {
            if (obtainStyledAttributes.getResourceId(k.f14996c8, -1) != -1) {
                z11 = true;
            }
            z10 = z11;
        } else {
    ...
    public static boolean g(Context context) {
        return f5.b.b(context, b.isMaterial3Theme, false);
    }
