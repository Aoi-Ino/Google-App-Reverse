...
public class g0 {
    ...
    private String w(String str) {
        if (!this.f7496a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f7496a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f7496a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f7496a);
        for (String next : this.f7496a.keySet()) {
            if (!s(next)) {
                bundle.remove(next);
            }
        }
