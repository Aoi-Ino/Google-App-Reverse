...
public final class a extends RecyclerView.h {
    ...
    private final Application f9130e;

    /* renamed from: f  reason: collision with root package name */
    private final ArrayList f9131f;

    /* renamed from: g  reason: collision with root package name */
    private final C0119a f9132g;

    /* renamed from: h  reason: collision with root package name */
    private Calendar f9133h = Calendar.getInstance();

    /* renamed from: com.nic.mparivahan.LLServices.UI.a$a  reason: collision with other inner class name */
    ...
    public static final class b extends RecyclerView.d0 {
        ...
        private final LinearLayout f9134y;

        /* renamed from: z  reason: collision with root package name */
        private final ImageView f9135z;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public b(View view) {
            super(view);
            l.f(view, "view");
            this.f9134y = (LinearLayout) view.findViewById(R.id.view_or_uploaded_doc_ll);
            this.f9135z = (ImageView) view.findViewById(R.id.doc_selected_iv);
        ...
        private final void g0(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem r9) {
            ...
            L_0x0077:
                ...
                r0.setVisibility(r6)     // Catch:{ Exception -> 0x012d }
                android.widget.LinearLayout r0 = r8.f9134y     // Catch:{ Exception -> 0x012d }
                ...
                android.widget.ImageView r0 = r8.f9135z     // Catch:{ Exception -> 0x012d }
            ...
            L_0x00e6:
                ...
                android.widget.ImageView r9 = r8.f9135z     // Catch:{ Exception -> 0x012d }
            ...
            L_0x0106:
                android.widget.LinearLayout r9 = r8.f9134y     // Catch:{ Exception -> 0x012d }
                r9.setVisibility(r7)     // Catch:{ Exception -> 0x012d }
            ...
            L_0x012d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nic.mparivahan.LLServices.UI.a.b.g0(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem):void");
        }
    ...
    public static final class c implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f9136e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f9137f;

        c(DocumentListItem documentListItem, b bVar) {
            this.f9136e = documentListItem;
            this.f9137f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f9136e;
            if (documentListItem != null) {
                documentListItem.setIssueAuthDesg(this.f9137f.a0().getText().toString());
            }
            DocumentListItem documentListItem2 = this.f9136e;
    ...
    public static final class d implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f9138e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f9139f;

        d(DocumentListItem documentListItem, b bVar) {
            this.f9138e = documentListItem;
            this.f9139f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f9138e;
            if (documentListItem != null) {
                documentListItem.setDocNo(this.f9139f.V().getText().toString());
            }
        }
    }
    ...
    public static final class e implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f9140e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f9141f;

        e(DocumentListItem documentListItem, b bVar) {
            this.f9140e = documentListItem;
            this.f9141f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f9140e;
            if (documentListItem != null) {
                documentListItem.setContactNo(this.f9141f.T().getText().toString());
            }
        }
    }
    ...
    public static final class f implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f9142e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f9143f;

        f(DocumentListItem documentListItem, b bVar) {
            this.f9142e = documentListItem;
            this.f9143f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f9142e;
            if (documentListItem != null) {
                documentListItem.setIssueDate(this.f9143f.b0().getText().toString());
            }
        }
    }
    ...
    static final class g extends m implements bm.l {
        ...
        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f9145f;

        /* renamed from: g  reason: collision with root package name */
        final /* synthetic */ int f9146g;
        ...
        public final void b(UploadDocListResponse uploadDocListResponse) {
            ...
            if (responseBean != null && (statusCode = responseBean.getStatusCode()) != null && statusCode.intValue() == 200) {
                ...
                EditText W = this.f9145f.W();
                l.e(W, "<get-docType>(...)");
                aVar.Y(proofList, W, this.f9146g);
            }
        }
    ...
    public static final class h implements e.b {
        ...
        public void a(String str, int i10) {
            ...
            ArrayList L = this.f9148b.L();
            String str2 = null;
            DocumentListItem documentListItem = L != null ? (DocumentListItem) L.get(this.f9149c) : null;
            if (documentListItem != null) {
            ...
            ArrayList L2 = this.f9148b.L();
            DocumentListItem documentListItem2 = L2 != null ? (DocumentListItem) L2.get(this.f9149c) : null;
            if (documentListItem2 != null) {
                List list2 = this.f9150d;
                documentListItem2.setProofCode((list2 == null || (proofList2 = (ProofList) list2.get(i10)) == null) ? null : proofList2.getId());
            }
            ArrayList L3 = this.f9148b.L();
            DocumentListItem documentListItem3 = L3 != null ? (DocumentListItem) L3.get(this.f9149c) : null;
            if (documentListItem3 != null) {
                List list3 = this.f9150d;
    ...
    static final class i implements b0, cm.h {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ bm.l f9151a;
    ...
    public a(Context context, Application application, ArrayList arrayList, C0119a aVar) {
        l.f(context, "context");
        l.f(application, "application");
        l.f(aVar, "itemListener");
        this.f9129d = context;
        this.f9130e = application;
    ...
    public static final void N(DocumentListItem documentListItem, b bVar, a aVar, u uVar, int i10, View view) {
        ...
        if (bVar.W().getText().toString().length() <= 0) {
            ...
            aVar.f9132g.b(i10, documentListItem);
        }
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void P(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem r17, com.nic.mparivahan.LLServices.UI.a r18, int r19, cm.u r20, com.nic.mparivahan.LLServices.UI.a.b r21, android.view.View r22) {
        /*
            r0 = r18
            r1 = r19
            r2 = r20
        ...
        L_0x006c:
            ...
            r5.append(r4)
            java.util.ArrayList r4 = r0.f9131f
        ...
        L_0x00d6:
            ...
            android.content.Context r5 = r0.f9129d
            r4.<init>(r5)
            ...
            ld.c r7 = (ld.c) r7
            android.content.Context r8 = r0.f9129d
            ...
            goto L_0x0163
        L_0x0149:
            android.content.Context r0 = r0.f9129d
        ...
        L_0x01d8:
            ...
            r3.<init>(r1)
            android.content.Context r1 = r0.f9129d
            ...
            android.content.Context r0 = r0.f9129d     // Catch:{ Exception -> 0x0243 }
        ...
        L_0x0243:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nic.mparivahan.LLServices.UI.a.P(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem, com.nic.mparivahan.LLServices.UI.a, int, cm.u, com.nic.mparivahan.LLServices.UI.a$b, android.view.View):void");
    }
    ...
    public static final void R(DocumentListItem documentListItem, a aVar, b bVar, View view) {
        ...
        if (documentListItem == null || !documentListItem.isDocInsertedStatus()) {
            DatePickerDialog datePickerDialog = new DatePickerDialog(aVar.f9129d, new p0(bVar), aVar.f9133h.get(1), aVar.f9133h.get(2), aVar.f9133h.get(5));
    ...
    public static final void T(DocumentListItem documentListItem, a aVar, b bVar, int i10, View view) {
        ...
        l.f(bVar, "$holder");
        if (documentListItem == null || !documentListItem.isDocInsertedStatus()) {
            Application application = aVar.f9130e;
            String str = null;
    ...
    public static final void W(DocumentListItem documentListItem, b bVar, a aVar, u uVar, int i10, View view) {
        ...
        if (bVar.W().getText().toString().length() <= 0) {
            ...
            aVar.f9132g.c(i10, documentListItem);
        }
    }
    ...
    public void p(b bVar, int i10) {
        ...
        u uVar = new u();
        uVar.f20234e = new ld.c(this.f9129d);
        bVar.W().setHint(((ld.c) uVar.f20234e).b("select_documents", this.f9129d.getString(R.string.select_documents)));
        bVar.a0().setHint(((ld.c) uVar.f20234e).b("issuer", this.f9129d.getString(R.string.issuer)));
        bVar.V().setHint(((ld.c) uVar.f20234e).b("doc_number", this.f9129d.getString(R.string.doc_number)));
        bVar.T().setHint(((ld.c) uVar.f20234e).b("con_number", this.f9129d.getString(R.string.con_number)));
        bVar.b0().setHint(((ld.c) uVar.f20234e).b("d_i_d", this.f9129d.getString(R.string.d_i_d)));
        bVar.Y().setText(((ld.c) uVar.f20234e).b("doc_documents", this.f9129d.getString(R.string.documents)));
        bVar.Z().setText(((ld.c) uVar.f20234e).b("label_gallery", this.f9129d.getString(R.string.gallery)));
        bVar.X().setText(((ld.c) uVar.f20234e).b("label_capture", this.f9129d.getString(R.string.capture)));
