...
public final class SaveOtpRes extends Worker {
    ...
    public static final a f8723k = new a((g) null);

    /* renamed from: j  reason: collision with root package name */
    private Context f8724j;
    ...
    public SaveOtpRes(Context context, WorkerParameters workerParameters) {
    ...
    private final JSONObject s(String str, String str2, String str3, String str4, int i10) {
        ...
        try {
            ...
            jSONObject3.put("mSaveOtpRes", (Object) jSONObject2);
            return jSONObject3;
        } catch (Exception unused) {
            return jSONObject;
        }
    ...
    public final void r(String str, String str2, String str3, String str4, int i10) {
        ...
        l.f(str3, "avTxn");
        l.f(str4, "avExt1");
        DlLogInterface b10 = DlLogInterface.f21658a.b(this.f8724j);
        c0.a aVar = c0.Companion;
        x b11 = x.f32156g.b("application/json");
        String jSONObject = s(str, str2, str3, str4, i10).toString();
        l.e(jSONObject, "toString(...)");
        c0 f10 = aVar.f(b11, jSONObject);
        String valueOf = String.valueOf(System.currentTimeMillis());
        b10.saveOtpResInter(f10, valueOf).enqueue(new b(valueOf));
    }
}
