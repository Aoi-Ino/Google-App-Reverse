...
public final class DlFeePayment extends androidx.appcompat.app.d {
    ...
    private static final class a {
        ...
        public final void showHTML(java.lang.String r5) {
            ...
            L_0x003b:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nic.mparivahan.NewDlScreen.DlAcknow.DlFeePayment.a.showHTML(java.lang.String):void");
        }
    }
    ...
    public static final class c extends WebViewClient {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ DlFeePayment f9303a;

        c(DlFeePayment dlFeePayment) {
            this.f9303a = dlFeePayment;
        }
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            if (str != null) {
                ...
                if (q.F(str, "callback/sarathiPGResponse", false, 2, (Object) null)) {
                    ...
                    String m12 = this.f9303a.S;
                    String o12 = this.f9303a.I;
                    if (o12 == null) {
                        l.v("mApplDob");
                    } else {
                        str2 = o12;
    ...
    static final class d extends m implements bm.l {
        ...
        final /* synthetic */ DlFeePayment f9304e;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        d(DlFeePayment dlFeePayment) {
            super(1);
            this.f9304e = dlFeePayment;
        }
        ...
        public final void b(DlApplStatusDto dlApplStatusDto) {
            ...
            if (p.p(dlApplStatusDto != null ? dlApplStatusDto.getStatusCode() : null, "00", false, 2, (Object) null) && dlApplStatusDto != null && (applStatusDetails = dlApplStatusDto.getApplStatusDetails()) != null && (!applStatusDetails.isEmpty()) && (applStatusDetailsItem = dlApplStatusDto.getApplStatusDetails().get(0)) != null && (applFlowStatusList = applStatusDetailsItem.getApplFlowStatusList()) != null && (!applFlowStatusList.isEmpty())) {
                this.f9304e.F1(applStatusDetailsItem.getApplFlowStatusList());
            }
        }
    ...
    public static final class e extends BroadcastReceiver {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ DlFeePayment f9305a;

        e(DlFeePayment dlFeePayment) {
            this.f9305a = dlFeePayment;
        }

        public void onReceive(Context context, Intent intent) {
            n2 n2Var = null;
            this.f9305a.S = String.valueOf(intent != null ? intent.getStringExtra("applNum") : null);
            String stringExtra = intent != null ? intent.getStringExtra("respCode") : null;
            if (this.f9305a.S.length() > 0 && stringExtra != null && stringExtra.length() > 0) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(hc.a.f12073a.x());
                sb2.append("PrintConformMob.jsp?applno=");
                String p12 = this.f9305a.H;
                if (p12 == null) {
                    l.v("mApplNo");
                    p12 = null;
                }
    ...
    static final class f implements b0, cm.h {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ bm.l f9306a;
    ...
    public static final class h extends WebViewClient {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ DlFeePayment f9307a;

        h(DlFeePayment dlFeePayment) {
            this.f9307a = dlFeePayment;
        }

        public void onPageFinished(WebView webView, String str) {
            this.f9307a.J = true;
            n2 n12 = this.f9307a.G;
            n2 n2Var = null;
            if (n12 == null) {
                l.v("cBinding");
                n12 = null;
        ...
        public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
            ...
            Toast.makeText(this.f9307a, "Service is temporary unavailable. Try After some time", 1).show();
            n2 n12 = this.f9307a.G;
            n2 n2Var = null;
            if (n12 == null) {
                l.v("cBinding");
    ...
    /* access modifiers changed from: private */
    public static final void E1(Dialog dialog, DlFeePayment dlFeePayment, View view) {
        l.f(dialog, "$d");
        l.f(dlFeePayment, "this$0");
        dialog.dismiss();
        Intent intent = new Intent(dlFeePayment, DashBoard.class);
        intent.setFlags(67108864);
        dlFeePayment.startActivity(intent);
        dlFeePayment.finish();
    }
    ...
    /* access modifiers changed from: private */
    public static final void H1(DlFeePayment dlFeePayment) {
        l.f(dlFeePayment, "this$0");
        dlFeePayment.K = false;
    }
    ...
    private final void M1() {
        ...
        n2Var15.B.setDownloadListener(new gc.q(this));
        StringBuilder sb2 = new StringBuilder();
        sb2.append(hc.a.f12073a.x());
    ...
    /* access modifiers changed from: private */
    public static final void N1(DlFeePayment dlFeePayment, String str, String str2, String str3, String str4, long j10) {
        l.f(dlFeePayment, "this$0");
        if (dlFeePayment.checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") != 0) {
            androidx.core.app.b.s(dlFeePayment, new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 1);
        }
    }

    /* access modifiers changed from: private */
    public static final void v1(String str, String str2, DlFeePayment dlFeePayment, Dialog dialog, View view) {
        l.f(str, "$url");
        l.f(str2, "$userAgent");
        l.f(dlFeePayment, "this$0");
        l.f(dialog, "$screen16");
        ...
        Object systemService = dlFeePayment.getSystemService("download");
    ...
    public final void x1(String str) {
        ...
        n2Var5.A.setDownloadListener(new o(this));
        n2 n2Var6 = this.G;
        if (n2Var6 == null) {
            l.v("cBinding");
            n2Var6 = null;
    ...
    /* access modifiers changed from: private */
    public static final void y1(DlFeePayment dlFeePayment, String str, String str2, String str3, String str4, long j10) {
        l.f(dlFeePayment, "this$0");
        if (dlFeePayment.checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") == 0) {
            l.c(str);
            l.c(str2);
            l.c(str3);
            l.c(str4);
            dlFeePayment.u1(str, str2, str3, str4);
            return;
        }
        androidx.core.app.b.s(dlFeePayment, new String[]{"android.permission.WRITE_EXTERNAL_STORAGE"}, 1);
    }
    ...
    public final void u1(String str, String str2, String str3, String str4) {
        ...
        ((TextView) findViewById3).setOnClickListener(new s(sb3, str2, this, dialog));
