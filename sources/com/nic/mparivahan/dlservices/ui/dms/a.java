...
public final class a extends RecyclerView.h {
    ...
    private final Context f22050d;

    /* renamed from: e  reason: collision with root package name */
    private final Application f22051e;

    /* renamed from: f  reason: collision with root package name */
    private final ArrayList f22052f;

    /* renamed from: g  reason: collision with root package name */
    private final C0273a f22053g;

    /* renamed from: h  reason: collision with root package name */
    private Calendar f22054h = Calendar.getInstance();

    /* renamed from: com.nic.mparivahan.dlservices.ui.dms.a$a  reason: collision with other inner class name */
    ...
    public static final class b extends RecyclerView.d0 {
        ...
        private final LinearLayout f22055y;

        /* renamed from: z  reason: collision with root package name */
        private final ImageView f22056z;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public b(View view) {
            super(view);
            l.f(view, "view");
            this.f22055y = (LinearLayout) view.findViewById(R.id.view_or_uploaded_doc_ll);
            this.f22056z = (ImageView) view.findViewById(R.id.doc_selected_iv);
        ...
        private final void g0(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem r9) {
            ...
            L_0x0077:
                ...
                r0.setVisibility(r6)     // Catch:{ Exception -> 0x012d }
                android.widget.LinearLayout r0 = r8.f22055y     // Catch:{ Exception -> 0x012d }
                ...
                android.widget.ImageView r0 = r8.f22056z     // Catch:{ Exception -> 0x012d }
            ...
            L_0x00e6:
                ...
                android.widget.ImageView r9 = r8.f22056z     // Catch:{ Exception -> 0x012d }
            ...
            L_0x0106:
                android.widget.LinearLayout r9 = r8.f22055y     // Catch:{ Exception -> 0x012d }
                r9.setVisibility(r7)     // Catch:{ Exception -> 0x012d }
            ...
            L_0x012d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nic.mparivahan.dlservices.ui.dms.a.b.g0(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem):void");
        }
    ...
    public static final class c implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f22057e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f22058f;

        c(DocumentListItem documentListItem, b bVar) {
            this.f22057e = documentListItem;
            this.f22058f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f22057e;
            if (documentListItem != null) {
                documentListItem.setIssueAuthDesg(this.f22058f.a0().getText().toString());
            }
            DocumentListItem documentListItem2 = this.f22057e;
    ...
    public static final class d implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f22059e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f22060f;

        d(DocumentListItem documentListItem, b bVar) {
            this.f22059e = documentListItem;
            this.f22060f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f22059e;
            if (documentListItem != null) {
                documentListItem.setDocNo(this.f22060f.V().getText().toString());
            }
        }
    }
    ...
    public static final class e implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f22061e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f22062f;

        e(DocumentListItem documentListItem, b bVar) {
            this.f22061e = documentListItem;
            this.f22062f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f22061e;
            if (documentListItem != null) {
                documentListItem.setContactNo(this.f22062f.T().getText().toString());
            }
        }
    }
    ...
    public static final class f implements TextWatcher {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ DocumentListItem f22063e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f22064f;

        f(DocumentListItem documentListItem, b bVar) {
            this.f22063e = documentListItem;
            this.f22064f = bVar;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            l.f(charSequence, "charSequence");
            DocumentListItem documentListItem = this.f22063e;
            if (documentListItem != null) {
                documentListItem.setIssueDate(this.f22064f.b0().getText().toString());
            }
        }
    }
    ...
    static final class g extends m implements bm.l {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ a f22065e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ b f22066f;

        /* renamed from: g  reason: collision with root package name */
        final /* synthetic */ int f22067g;
        ...
        public final void b(UploadDocListResponse uploadDocListResponse) {
            ...
            if (responseBean != null && (statusCode = responseBean.getStatusCode()) != null && statusCode.intValue() == 200) {
                ...
                EditText W = this.f22066f.W();
                l.e(W, "<get-docType>(...)");
                aVar.Y(proofList, W, this.f22067g);
            }
        }
    ...
    public static final class h implements e.b {
        ...
        public void a(String str, int i10) {
            ...
            this.f22068a.setText(str);
            ArrayList L = this.f22069b.L();
            String str2 = null;
            DocumentListItem documentListItem = L != null ? (DocumentListItem) L.get(this.f22070c) : null;
            if (documentListItem != null) {
                List list = this.f22071d;
                documentListItem.setDocName((list == null || (proofList3 = (ProofList) list.get(i10)) == null) ? null : proofList3.getName());
            }
            ArrayList L2 = this.f22069b.L();
            DocumentListItem documentListItem2 = L2 != null ? (DocumentListItem) L2.get(this.f22070c) : null;
            if (documentListItem2 != null) {
                List list2 = this.f22071d;
                documentListItem2.setProofCode((list2 == null || (proofList2 = (ProofList) list2.get(i10)) == null) ? null : proofList2.getId());
            }
            ArrayList L3 = this.f22069b.L();
            DocumentListItem documentListItem3 = L3 != null ? (DocumentListItem) L3.get(this.f22070c) : null;
            if (documentListItem3 != null) {
                List list3 = this.f22071d;
    ...
    static final class i implements b0, cm.h {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ bm.l f22072a;
    ...
    public a(Context context, Application application, ArrayList arrayList, C0273a aVar) {
        l.f(context, "context");
        l.f(application, "application");
        l.f(aVar, "itemListener");
        this.f22050d = context;
        this.f22051e = application;
    ...
    public static final void N(DocumentListItem documentListItem, b bVar, a aVar, u uVar, int i10, View view) {
        ...
        if (bVar.W().getText().toString().length() <= 0) {
            ...
            aVar.f22053g.b(i10, documentListItem);
        }
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void P(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem r17, com.nic.mparivahan.dlservices.ui.dms.a r18, int r19, cm.u r20, com.nic.mparivahan.dlservices.ui.dms.a.b r21, android.view.View r22) {
        /*
            r0 = r18
            r1 = r19
            r2 = r20
        ...
        L_0x006c:
            ...
            r5.append(r4)
            java.util.ArrayList r4 = r0.f22052f
        ...
        L_0x00d6:
            ...
            android.content.Context r5 = r0.f22050d
            r4.<init>(r5)
            ...
            ld.c r7 = (ld.c) r7
            android.content.Context r8 = r0.f22050d
            ...
            goto L_0x0163
        L_0x0149:
            android.content.Context r0 = r0.f22050d
        ...
        L_0x01d8:
            ...
            r3.<init>(r1)
            android.content.Context r1 = r0.f22050d
            ...
            android.content.Context r0 = r0.f22050d     // Catch:{ Exception -> 0x0243 }
        ...
        L_0x0243:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nic.mparivahan.dlservices.ui.dms.a.P(com.nic.mparivahan.dlservices.data.model.temp.DocumentListItem, com.nic.mparivahan.dlservices.ui.dms.a, int, cm.u, com.nic.mparivahan.dlservices.ui.dms.a$b, android.view.View):void");
    }
    ...
    public static final void R(DocumentListItem documentListItem, a aVar, b bVar, View view) {
        ...
        if (documentListItem == null || !documentListItem.isDocInsertedStatus()) {
            DatePickerDialog datePickerDialog = new DatePickerDialog(aVar.f22050d, new a0(bVar), aVar.f22054h.get(1), aVar.f22054h.get(2), aVar.f22054h.get(5));
    ...
    public static final void T(DocumentListItem documentListItem, a aVar, b bVar, int i10, View view) {
        ...
        l.f(bVar, "$holder");
        if (documentListItem == null || !documentListItem.isDocInsertedStatus()) {
            Application application = aVar.f22051e;
            String str = null;
    ...
    public static final void W(DocumentListItem documentListItem, b bVar, a aVar, u uVar, int i10, View view) {
        ...
        if (bVar.W().getText().toString().length() <= 0) {
            ...
            aVar.f22053g.c(i10, documentListItem);
        }
    }
    ...
    public void p(b bVar, int i10) {
        ...
        u uVar = new u();
        uVar.f20234e = new ld.c(this.f22050d);
        bVar.W().setHint(((ld.c) uVar.f20234e).b("select_documents", this.f22050d.getString(R.string.select_documents)));
        bVar.a0().setHint(((ld.c) uVar.f20234e).b("issuer", this.f22050d.getString(R.string.issuer)));
        bVar.V().setHint(((ld.c) uVar.f20234e).b("doc_number", this.f22050d.getString(R.string.doc_number)));
        bVar.T().setHint(((ld.c) uVar.f20234e).b("con_number", this.f22050d.getString(R.string.con_number)));
        bVar.b0().setHint(((ld.c) uVar.f20234e).b("d_i_d", this.f22050d.getString(R.string.d_i_d)));
        bVar.Y().setText(((ld.c) uVar.f20234e).b("doc_documents", this.f22050d.getString(R.string.documents)));
        bVar.Z().setText(((ld.c) uVar.f20234e).b("label_gallery", this.f22050d.getString(R.string.gallery)));
        bVar.X().setText(((ld.c) uVar.f20234e).b("label_capture", this.f22050d.getString(R.string.capture)));
        ...
        bVar.b0().setOnClickListener(new r(documentListItem, this, bVar));
        bVar.W().setOnClickListener(new s(documentListItem, this, bVar, i10));
        bVar.P().setOnClickListener(new t(bVar));
        bVar.Q().setOnClickListener(new nj.u(bVar));
        DocumentListItem documentListItem2 = documentListItem;
        b bVar2 = bVar;
        u uVar2 = uVar;
        int i11 = i10;
        bVar.S().setOnClickListener(new v(documentListItem2, bVar2, this, uVar2, i11));
        bVar.R().setOnClickListener(new w(documentListItem2, bVar2, this, uVar2, i11));
        bVar.U().setOnClickListener(new nj.x(this, i10));
        bVar.e0().setOnClickListener(new y(documentListItem, this, i10, uVar2, bVar));
    }
    ...
    public final void Z(int i10) {
        ...
        n(i10);
        ArrayList arrayList2 = this.f22052f;
        if (arrayList2 != null) {
