...
public interface VersionService {
    ...
    public static final a f21650a = a.f21651a;

    public static final class a {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ a f21651a = new a();

        /* renamed from: b  reason: collision with root package name */
        private static z f21652b;

        /* renamed from: c  reason: collision with root package name */
        private static VersionService f21653c;

        /* renamed from: d  reason: collision with root package name */
        private static String f21654d = String.valueOf(System.currentTimeMillis());

        static {
            z.a aVar = new z.a();
            TimeUnit timeUnit = TimeUnit.SECONDS;
            f21652b = aVar.d(60, timeUnit).J(60, timeUnit).M(60, timeUnit).a(d.f17494a.d()).c();
        }
        ...
        public final VersionService c(Context context) {
            z.a L;
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                TimeUnit timeUnit = TimeUnit.SECONDS;
                z.a a11 = a10.d(5, timeUnit).J(5, timeUnit).M(5, timeUnit).a(d.f17494a.d());
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0064: CONSTRUCTOR  (r0v25 ? I:ii.l) =  call: ii.l.<init>():void type: CONSTRUCTOR in method: com.nic.mparivahan.Welcome.VersionService.a.c(android.content.Context):com.nic.mparivahan.Welcome.VersionService, dex: classes3.dex
                ...
                L_0x0070:
                    ...
                    goto L_0x0067
                L_0x00c3:
                    com.nic.mparivahan.Welcome.VersionService r0 = f21653c
                    ...
                    java.lang.Class<com.nic.mparivahan.Welcome.VersionService> r0 = com.nic.mparivahan.Welcome.VersionService.class
                    java.lang.Object r9 = r9.create(r0)
                    com.nic.mparivahan.Welcome.VersionService r9 = (com.nic.mparivahan.Welcome.VersionService) r9
                    f21653c = r9
                L_0x00f0:
                    com.nic.mparivahan.Welcome.VersionService r9 = f21653c
                    cm.l.c(r9)
                    return r9
                */
                throw new UnsupportedOperationException("Method not decompiled: com.nic.mparivahan.Welcome.VersionService.a.c(android.content.Context):com.nic.mparivahan.Welcome.VersionService");
            }
        }

        @POST
        @Headers({"Content-Type: application/json", "Accept: application/json"})
        Call<SecurityModle> getBannerList(@Url String str, @Body c0 c0Var, @Header("timestamp") String str2);

        @POST("service/getServiceEnabledStates")
        @Headers({"Content-Type: application/json", "Accept: application/json"})
        Call<SecurityModle> getServiceEnabledStates(@Body c0 c0Var, @Header("timestamp") String str);
        ...
        @POST
        @Headers({"Content-Type: application/json", "Accept: application/json"})
        Call<SecurityModle> getVersion(@Url String str, @Body c0 c0Var, @Header("timestamp") String str2);
    }
