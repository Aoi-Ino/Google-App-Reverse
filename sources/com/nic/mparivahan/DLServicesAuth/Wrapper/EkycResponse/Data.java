...
public final class Data {
    ...
    public final Data copy(String str, String str2, String str3, DOAadhaarResponse dOAadhaarResponse2, String str4, String str5, String str6, String str7, String str8, boolean z10, List<String> list, String str9, String str10, String str11, String str12) {
        ...
        l.f(str23, "txNo");
        l.f(str12, "userId");
        return new Data(str13, str14, str15, dOAadhaarResponse3, str16, str17, str18, str19, str20, z10, list2, str21, str22, str23, str12);
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((hashCode + (z10 ? 1 : 0)) * 31) + this.purCd.hashCode()) * 31) + this.regNo.hashCode()) * 31) + this.stateCd.hashCode()) * 31) + this.txNo.hashCode()) * 31) + this.userId.hashCode();
    }
