...
public final class DOAadhaarResponse implements Serializable {
    ...
    public int hashCode() {
        int hashCode = ((this.biodeviceinfo.hashCode() * 31) + this.dOAuthOTP.hashCode()) * 31;
        DOEkyc dOEkyc2 = this.dOEkyc;
        return ((((((((((((hashCode + (dOEkyc2 == null ? 0 : dOEkyc2.hashCode())) * 31) + this.finalxml.hashCode()) * 31) + Integer.hashCode(this.pur_cd)) * 31) + this.reason.hashCode()) * 31) + this.regn_no.hashCode()) * 31) + this.status.hashCode()) * 31) + this.txnNo.hashCode();
    }
