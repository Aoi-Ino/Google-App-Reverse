...
@Keep
public final class ApiMessage implements Serializable {
    private final String developerMessage;
    private final String message;
    private final List<MessageParam> messageParam;
    private final int statusCode;

    public ApiMessage(String str, String str2, List<MessageParam> list, int i10) {
        l.f(str, "developerMessage");
        l.f(str2, "message");
        l.f(list, "messageParam");
        this.developerMessage = str;
        this.message = str2;
        this.messageParam = list;
        this.statusCode = i10;
    }

    public static /* synthetic */ ApiMessage copy$default(ApiMessage apiMessage, String str, String str2, List<MessageParam> list, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return apiMessage.copy(str, str2, list, i10);
    }
    ...
    public final ApiMessage copy(String str, String str2, List<MessageParam> list, int i10) {
        l.f(str, "developerMessage");
        l.f(str2, "message");
        l.f(list, "messageParam");
        return new ApiMessage(str, str2, list, i10);
    }
