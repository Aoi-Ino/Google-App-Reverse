...
public interface TOSaveToDraftService {
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ a f21432a = new a();

        /* renamed from: b  reason: collision with root package name */
        private static TOSaveToDraftService f21433b;
        ...
        public final TOSaveToDraftService b(Context context) {
            z.a I;
            l.f(context, "context");
            ...
            z c10 = I.c();
            if (f21433b == null) {
                f21433b = (TOSaveToDraftService) new Retrofit.Builder().baseUrl(hc.a.f12073a.m()).addConverterFactory(GsonConverterFactory.create()).client(c10).build().create(TOSaveToDraftService.class);
            }
            TOSaveToDraftService tOSaveToDraftService = f21433b;
            l.c(tOSaveToDraftService);
