...
@Keep
public final class SpecialPermitDto implements Serializable {
    ...
    public SpecialPermitDto(String str, String str2, String str3, String str4, String str5, String str6, String str7, int i10, String str8, int i11, String str9, int i12, String str10, String str11, String str12, String str13, String str14, String str15, List<VaSplPassengerdto> list, String str16, String str17) {
        String str18 = str;
        String str19 = str2;
        String str20 = str3;
        String str21 = str4;
    ...
    public static /* synthetic */ SpecialPermitDto copy$default(SpecialPermitDto specialPermitDto, String str, String str2, String str3, String str4, String str5, String str6, String str7, int i10, String str8, int i11, String str9, int i12, String str10, String str11, String str12, String str13, String str14, String str15, List list, String str16, String str17, int i13, Object obj) {
        SpecialPermitDto specialPermitDto2 = specialPermitDto;
        int i14 = i13;
        return specialPermitDto.copy((i14 & 1) != 0 ? specialPermitDto2.allotmentOffice : str, (i14 & 2) != 0 ? specialPermitDto2.applNo : str2, (i14 & 4) != 0 ? specialPermitDto2.goodsDetails : str3, (i14 & 8) != 0 ? specialPermitDto2.goodsToCarry : str4, (i14 & 16) != 0 ? specialPermitDto2.goodsType : str5, (i14 & 32) != 0 ? specialPermitDto2.ipAddress : str6, (i14 & 64) != 0 ? specialPermitDto2.issueDt : str7, (i14 & 128) != 0 ? specialPermitDto2.offCd : i10, (i14 & 256) != 0 ? specialPermitDto2.others : str8, (i14 & 512) != 0 ? specialPermitDto2.period : i11, (i14 & 1024) != 0 ? specialPermitDto2.periodMode : str9, (i14 & 2048) != 0 ? specialPermitDto2.purCd : i12, (i14 & 4096) != 0 ? specialPermitDto2.purposeOfJourny : str10, (i14 & 8192) != 0 ? specialPermitDto2.regnNo : str11, (i14 & 16384) != 0 ? specialPermitDto2.routeDescription : str12, (i14 & 32768) != 0 ? specialPermitDto2.stateCd : str13, (i14 & 65536) != 0 ? specialPermitDto2.travelFrom : str14, (i14 & 131072) != 0 ? specialPermitDto2.travelUpto : str15, (i14 & 262144) != 0 ? specialPermitDto2.vaSplPassengerdto : list, (i14 & 524288) != 0 ? specialPermitDto2.validFrom : str16, (i14 & 1048576) != 0 ? specialPermitDto2.validUpto : str17);
    }
    ...
    public final SpecialPermitDto copy(String str, String str2, String str3, String str4, String str5, String str6, String str7, int i10, String str8, int i11, String str9, int i12, String str10, String str11, String str12, String str13, String str14, String str15, List<VaSplPassengerdto> list, String str16, String str17) {
        String str18 = str;
        l.f(str18, "allotmentOffice");
        l.f(str2, "applNo");
        ...
        l.f(str16, "validFrom");
        l.f(str17, "validUpto");
        return new SpecialPermitDto(str18, str2, str3, str4, str5, str6, str7, i10, str8, i11, str9, i12, str10, str11, str12, str13, str14, str15, list, str16, str17);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SpecialPermitDto)) {
            return false;
        }
        SpecialPermitDto specialPermitDto = (SpecialPermitDto) obj;
        return l.a(this.allotmentOffice, specialPermitDto.allotmentOffice) && l.a(this.applNo, specialPermitDto.applNo) && l.a(this.goodsDetails, specialPermitDto.goodsDetails) && l.a(this.goodsToCarry, specialPermitDto.goodsToCarry) && l.a(this.goodsType, specialPermitDto.goodsType) && l.a(this.ipAddress, specialPermitDto.ipAddress) && l.a(this.issueDt, specialPermitDto.issueDt) && this.offCd == specialPermitDto.offCd && l.a(this.others, specialPermitDto.others) && this.period == specialPermitDto.period && l.a(this.periodMode, specialPermitDto.periodMode) && this.purCd == specialPermitDto.purCd && l.a(this.purposeOfJourny, specialPermitDto.purposeOfJourny) && l.a(this.regnNo, specialPermitDto.regnNo) && l.a(this.routeDescription, specialPermitDto.routeDescription) && l.a(this.stateCd, specialPermitDto.stateCd) && l.a(this.travelFrom, specialPermitDto.travelFrom) && l.a(this.travelUpto, specialPermitDto.travelUpto) && l.a(this.vaSplPassengerdto, specialPermitDto.vaSplPassengerdto) && l.a(this.validFrom, specialPermitDto.validFrom) && l.a(this.validUpto, specialPermitDto.validUpto);
    }
