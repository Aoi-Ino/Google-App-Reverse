...
public final class Fees implements Serializable {
    ...
    public Fees(boolean z10, String str, String str2, int i10, int i11, int i12, String str3, int i13, String str4, String str5, String str6, String str7, boolean z11, boolean z12, int i14, boolean z13, boolean z14, boolean z15, int i15, int i16, String str8, String str9) {
        String str10 = str3;
        String str11 = str4;
        String str12 = str5;
        String str13 = str6;
    ...
    public static /* synthetic */ Fees copy$default(Fees fees, boolean z10, String str, String str2, int i10, int i11, int i12, String str3, int i13, String str4, String str5, String str6, String str7, boolean z11, boolean z12, int i14, boolean z13, boolean z14, boolean z15, int i15, int i16, String str8, String str9, int i17, Object obj) {
        Fees fees2 = fees;
        int i18 = i17;
        return fees.copy((i18 & 1) != 0 ? fees2.disableDropDown : z10, (i18 & 2) != 0 ? fees2.dueDate : str, (i18 & 4) != 0 ? fees2.dueDateString : str2, (i18 & 8) != 0 ? fees2.exemptFeesAmount : i10, (i18 & 16) != 0 ? fees2.exemptFineAmount : i11, (i18 & 32) != 0 ? fees2.feeAmount : i12, (i18 & 64) != 0 ? fees2.feeHeadDescr : str3, (i18 & 128) != 0 ? fees2.fineAmount : i13, (i18 & 256) != 0 ? fees2.fromDate : str4, (i18 & 512) != 0 ? fees2.fromDateLable : str5, (i18 & 1024) != 0 ? fees2.noOfApplications : str6, (i18 & 2048) != 0 ? fees2.paymentId : str7, (i18 & 4096) != 0 ? fees2.perRcpt : z11, (i18 & 8192) != 0 ? fees2.perTrans : z12, (i18 & 16384) != 0 ? fees2.purCd : i14, (i18 & 32768) != 0 ? fees2.readOnlyFee : z13, (i18 & 65536) != 0 ? fees2.renderFromDate : z14, (i18 & 131072) != 0 ? fees2.renderUptoDate : z15, (i18 & 262144) != 0 ? fees2.servicecharge : i15, (i18 & 524288) != 0 ? fees2.totalAmount : i16, (i18 & 1048576) != 0 ? fees2.uptoDate : str8, (i18 & 2097152) != 0 ? fees2.uptoDateLable : str9);
    }
    ...
    public final Fees copy(boolean z10, String str, String str2, int i10, int i11, int i12, String str3, int i13, String str4, String str5, String str6, String str7, boolean z11, boolean z12, int i14, boolean z13, boolean z14, boolean z15, int i15, int i16, String str8, String str9) {
        boolean z16 = z10;
        l.f(str, "dueDate");
        l.f(str2, "dueDateString");
        ...
        return new Fees(z10, str, str2, i10, i11, i12, str3, i13, str4, str5, str6, str7, z11, z12, i14, z13, z14, z15, i15, i16, str8, str9);
    }
    ...
    public boolean equals(Object obj) {
        ...
        Fees fees = (Fees) obj;
        return this.disableDropDown == fees.disableDropDown && l.a(this.dueDate, fees.dueDate) && l.a(this.dueDateString, fees.dueDateString) && this.exemptFeesAmount == fees.exemptFeesAmount && this.exemptFineAmount == fees.exemptFineAmount && this.feeAmount == fees.feeAmount && l.a(this.feeHeadDescr, fees.feeHeadDescr) && this.fineAmount == fees.fineAmount && l.a(this.fromDate, fees.fromDate) && l.a(this.fromDateLable, fees.fromDateLable) && l.a(this.noOfApplications, fees.noOfApplications) && l.a(this.paymentId, fees.paymentId) && this.perRcpt == fees.perRcpt && this.perTrans == fees.perTrans && this.purCd == fees.purCd && this.readOnlyFee == fees.readOnlyFee && this.renderFromDate == fees.renderFromDate && this.renderUptoDate == fees.renderUptoDate && this.servicecharge == fees.servicecharge && this.totalAmount == fees.totalAmount && l.a(this.uptoDate, fees.uptoDate) && l.a(this.uptoDateLable, fees.uptoDateLable);
    }
