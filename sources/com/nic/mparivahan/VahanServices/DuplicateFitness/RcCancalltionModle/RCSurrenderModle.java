...
@Keep
public final class RCSurrenderModle {
    ...
    public RCSurrenderModle(String str, int i10, int i11, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18) {
        this.applNo = str;
        this.offCd = i10;
        this.purCd = i11;
        this.regnNo = str2;
    ...
    public static /* synthetic */ RCSurrenderModle copy$default(RCSurrenderModle rCSurrenderModle, String str, int i10, int i11, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18, int i12, Object obj) {
        RCSurrenderModle rCSurrenderModle2 = rCSurrenderModle;
        int i13 = i12;
        return rCSurrenderModle.copy((i13 & 1) != 0 ? rCSurrenderModle2.applNo : str, (i13 & 2) != 0 ? rCSurrenderModle2.offCd : i10, (i13 & 4) != 0 ? rCSurrenderModle2.purCd : i11, (i13 & 8) != 0 ? rCSurrenderModle2.regnNo : str2, (i13 & 16) != 0 ? rCSurrenderModle2.stateCd : str3, (i13 & 32) != 0 ? rCSurrenderModle2.surrDt : str4, (i13 & 64) != 0 ? rCSurrenderModle2.fileRefNo : str5, (i13 & 128) != 0 ? rCSurrenderModle2.approvedBy : str6, (i13 & 256) != 0 ? rCSurrenderModle2.reasonval : str7, (i13 & 512) != 0 ? rCSurrenderModle2.rcval : str8, (i13 & 1024) != 0 ? rCSurrenderModle2.rcSnoval : str9, (i13 & 2048) != 0 ? rCSurrenderModle2.permitval : str10, (i13 & 4096) != 0 ? rCSurrenderModle2.permitSnoval : str11, (i13 & 8192) != 0 ? rCSurrenderModle2.fcval : str12, (i13 & 16384) != 0 ? rCSurrenderModle2.fcSnoval : str13, (i13 & 32768) != 0 ? rCSurrenderModle2.taxexemval : str14, (i13 & 65536) != 0 ? rCSurrenderModle2.releaseDt : str15, (i13 & 131072) != 0 ? rCSurrenderModle2.relFileRefNo : str16, (i13 & 262144) != 0 ? rCSurrenderModle2.relApprovedBy : str17, (i13 & 524288) != 0 ? rCSurrenderModle2.cancelDt : str18);
    }
    ...
    public final RCSurrenderModle copy(String str, int i10, int i11, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, String str16, String str17, String str18) {
        return new RCSurrenderModle(str, i10, i11, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, str13, str14, str15, str16, str17, str18);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RCSurrenderModle)) {
            return false;
        }
        RCSurrenderModle rCSurrenderModle = (RCSurrenderModle) obj;
        return l.a(this.applNo, rCSurrenderModle.applNo) && this.offCd == rCSurrenderModle.offCd && this.purCd == rCSurrenderModle.purCd && l.a(this.regnNo, rCSurrenderModle.regnNo) && l.a(this.stateCd, rCSurrenderModle.stateCd) && l.a(this.surrDt, rCSurrenderModle.surrDt) && l.a(this.fileRefNo, rCSurrenderModle.fileRefNo) && l.a(this.approvedBy, rCSurrenderModle.approvedBy) && l.a(this.reasonval, rCSurrenderModle.reasonval) && l.a(this.rcval, rCSurrenderModle.rcval) && l.a(this.rcSnoval, rCSurrenderModle.rcSnoval) && l.a(this.permitval, rCSurrenderModle.permitval) && l.a(this.permitSnoval, rCSurrenderModle.permitSnoval) && l.a(this.fcval, rCSurrenderModle.fcval) && l.a(this.fcSnoval, rCSurrenderModle.fcSnoval) && l.a(this.taxexemval, rCSurrenderModle.taxexemval) && l.a(this.releaseDt, rCSurrenderModle.releaseDt) && l.a(this.relFileRefNo, rCSurrenderModle.relFileRefNo) && l.a(this.relApprovedBy, rCSurrenderModle.relApprovedBy) && l.a(this.cancelDt, rCSurrenderModle.cancelDt);
    }
