...
public final class DuprcDto implements Serializable {
    ...
    public DuprcDto(String str, int i10, String str2, String str3, int i11, String str4, int i12, String str5, String str6, int i13, String str7, String str8, String str9, int i14, String str10, String str11, int i15, String str12, String str13, String str14, String str15, String str16, String str17, int i16) {
        String str18 = str;
        String str19 = str2;
        String str20 = str3;
        String str21 = str4;
    ...
    public static /* synthetic */ DuprcDto copy$default(DuprcDto duprcDto, String str, int i10, String str2, String str3, int i11, String str4, int i12, String str5, String str6, int i13, String str7, String str8, String str9, int i14, String str10, String str11, int i15, String str12, String str13, String str14, String str15, String str16, String str17, int i16, int i17, Object obj) {
        ...
        int i18 = i17;
        return duprcDto.copy((i18 & 1) != 0 ? duprcDto2.appl_no : str, (i18 & 2) != 0 ? duprcDto2.comp_cd : i10, (i18 & 4) != 0 ? duprcDto2.fir_dt : str2, (i18 & 8) != 0 ? duprcDto2.fir_no : str3, (i18 & 16) != 0 ? duprcDto2.idv : i11, (i18 & 32) != 0 ? duprcDto2.ins_from : str4, (i18 & 64) != 0 ? duprcDto2.ins_type : i12, (i18 & 128) != 0 ? duprcDto2.ins_upto : str5, (i18 & 256) != 0 ? duprcDto2.msg : str6, (i18 & 512) != 0 ? duprcDto2.off_cd : i13, (i18 & 1024) != 0 ? duprcDto2.op_dt : str7, (i18 & 2048) != 0 ? duprcDto2.police_station : str8, (i18 & 4096) != 0 ? duprcDto2.policy_no : str9, (i18 & 8192) != 0 ? duprcDto2.pur_cd : i14, (i18 & 16384) != 0 ? duprcDto2.rcp_dt : str10, (i18 & 32768) != 0 ? duprcDto2.rcpt_NO : str11, (i18 & 65536) != 0 ? duprcDto2.rcpt_amt : i15, (i18 & 131072) != 0 ? duprcDto2.reason : str12, (i18 & 262144) != 0 ? duprcDto2.regn_no : str13, (i18 & 524288) != 0 ? duprcDto2.state_cd : str14, (i18 & 1048576) != 0 ? duprcDto2.state_header : str15, (i18 & 2097152) != 0 ? duprcDto2.status : str16, (i18 & 4194304) != 0 ? duprcDto2.tax_mode : str17, (i18 & 8388608) != 0 ? duprcDto2.vh_class : i16);
    }
    ...
    public final DuprcDto copy(String str, int i10, String str2, String str3, int i11, String str4, int i12, String str5, String str6, int i13, String str7, String str8, String str9, int i14, String str10, String str11, int i15, String str12, String str13, String str14, String str15, String str16, String str17, int i16) {
        String str18 = str;
        l.f(str18, "appl_no");
        l.f(str2, "fir_dt");
        l.f(str3, "fir_no");
        ...
        l.f(str16, "status");
        l.f(str17, "tax_mode");
        return new DuprcDto(str18, i10, str2, str3, i11, str4, i12, str5, str6, i13, str7, str8, str9, i14, str10, str11, i15, str12, str13, str14, str15, str16, str17, i16);
    }
