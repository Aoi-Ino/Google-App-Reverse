...
public final class w extends RecyclerView.h {
    ...
    private final ArrayList f13972d;
    ...
    private String f13975g = "T";

    public static final class a extends RecyclerView.d0 {
        private final ImageView A;

        /* renamed from: y  reason: collision with root package name */
        private final TextView f13976y;

        /* renamed from: z  reason: collision with root package name */
        private final LinearLayout f13977z;
        ...
        public a(View view) {
            ...
            this.f13976y = (TextView) findViewById;
            View findViewById2 = this.f3622e.findViewById(R.id.layout_es_sarathi);
            l.e(findViewById2, "findViewById(...)");
            this.f13977z = (LinearLayout) findViewById2;
    ...
    public w(ArrayList arrayList, Context context, String str) {
        l.f(arrayList, "mList");
    ...
    public static final void C(w wVar, Enabledservice enabledservice, View view) {
        l.f(wVar, "this$0");
        l.f(enabledservice, "$mModel");
        wVar.E(enabledservice.getServCode(), wVar.f13973e, enabledservice.getServName().toString());
    }

    /* renamed from: B */
    public void p(a aVar, int i10) {
        l.f(aVar, "holder");
        Object obj = this.f13972d.get(i10);
        l.e(obj, "get(...)");
        Enabledservice enabledservice = (Enabledservice) obj;
        aVar.P().setText(e.f17509a.T(this.f13973e, enabledservice.getServCode(), enabledservice.getServName()));
        F(enabledservice.getServCode(), aVar);
        aVar.Q().setOnClickListener(new v(this, enabledservice));
    }
    ...
    public final void E(String str, Context context, String str2) {
        ...
        if (str.equals(VContant.DUPLICATE_RC_PURPOSE_CODE)) {
            ...
            try {
                Intent intent2 = new Intent(this.f13973e, VahanDownloadReceiptActivity.class);
                intent2.putExtra("service_name", e.f17509a.T(this.f13973e, str, str2));
                this.f13973e.startActivity(intent2);
                return;
            } catch (Exception e10) {
                e10.printStackTrace();
                return;
            ...
            this.f13973e.startActivity(new Intent(this.f13973e, VahanVerifyPendingTransaction.class));
            return;
        } else if (str.equals("903")) {
            Intent intent3 = new Intent(this.f13973e, DownloadFormHomeScreen.class);
            intent3.putExtra("service_name", str2);
            this.f13973e.startActivity(intent3);
            return;
        } else if (str.equals("907")) {
            Intent intent4 = new Intent(this.f13973e, DownloadNocHomeScreen.class);
            intent4.putExtra("service_name", str2);
            this.f13973e.startActivity(intent4);
            return;
        } else if (str.equals("910")) {
            Intent intent5 = new Intent(this.f13973e, DuplicateFitnessCertificateDownload.class);
            intent5.putExtra("service_name", str2);
            this.f13973e.startActivity(intent5);
            return;
        ...
        intent.putExtra("state_code", this.f13974f);
        context.startActivity(intent);
    }
    ...
    public final void F(String str, a aVar) {
        ...
        l.f(aVar, "holder");
        if (str.equals(VContant.DUPLICATE_RC_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.duplicate_rc));
        }
        if (str.equals(VContant.CHANGE_OF_ADDRESS_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.mvvm_ic_addres));
        }
        if (str.equals(VContant.HYPOTHECATION_ADDITION_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.addition));
        }
        if (str.equals(VContant.HYPOTHICATION_TERMINATION_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.term));
        }
        if (str.equals(VContant.HYPOTHECATION_CONTINUATION_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.ic_con));
        }
        if (str.equals(VContant.RCPARTICULAR_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.rc_partucalar));
        }
        if (str.equals(VContant.NOC_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.duplicate_rc));
        }
        if (str.equals(VContant.Tax_PURPOSE_CODE)) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.bill));
        }
        if (str.equals("102")) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.vahan_dispose));
        }
        if (str.equals("103")) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.vahan_app_status));
        }
        if (str.equals("104")) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.smartphone));
        }
        if (str.equals("901")) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.print_rece));
        }
        if (str.equals("902")) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.vahan_verify_payment));
        }
        if (str.equals("903")) {
            aVar.O().setImageDrawable(this.f13973e.getResources().getDrawable(R.drawable.downloadforms));
        }
        if (str.equals("904")) {
            O = aVar.O();
            resources = this.f13973e.getResources();
            ...
            O = aVar.O();
            drawable = this.f13973e.getResources().getDrawable(i11);
