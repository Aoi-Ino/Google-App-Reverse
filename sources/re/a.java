...
public final class a extends BaseAdapter {
    ...
    private final ArrayList f31032f;
    ...
    public int getCount() {
        ArrayList arrayList = this.f31032f;
        l.c(arrayList);
    ...
    public View getView(int i10, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.f31031e).inflate(R.layout.coustome_spinner1, viewGroup, false);
        }
        l.c(view);
