...
public interface XmlElement extends XmlContainer {
    ...
    XmlAttribute addAttribute(String str, String str2, String str3, String str4, String str5, boolean z10);

    XmlAttribute addAttribute(String str, XmlNamespace xmlNamespace, String str2, String str3);

    XmlAttribute addAttribute(String str, XmlNamespace xmlNamespace, String str2, String str3, boolean z10);
    ...
    void addChild(int i10, Object obj);
    ...
    void ensureAttributeCapacity(int i10);

    void ensureChildrenCapacity(int i10);

    void ensureNamespaceDeclarationsCapacity(int i10);
    ...
    void insertChild(int i10, Object obj);
