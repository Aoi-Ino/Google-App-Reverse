...
public interface XmlSerializerWrapper extends XmlSerializer {
    ...
    void writeDouble(double d10) throws XmlPullParserException, IOException, IllegalArgumentException;

    void writeDoubleElement(String str, String str2, double d10) throws XmlPullParserException, IOException, IllegalArgumentException;

    void writeFloat(float f10) throws XmlPullParserException, IOException, IllegalArgumentException;

    void writeFloatElement(String str, String str2, float f10) throws XmlPullParserException, IOException, IllegalArgumentException;

    void writeInt(int i10) throws XmlPullParserException, IOException, IllegalArgumentException;

    void writeIntElement(String str, String str2, int i10) throws XmlPullParserException, IOException, IllegalArgumentException;
