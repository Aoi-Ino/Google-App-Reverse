...
public final class a extends x implements p0 {
    ...
    static /* synthetic */ class C0145a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f11355a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f11355a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f11355a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f11355a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f11355a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f11355a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: f6.a.C0145a.<clinit>():void");
        }
    }
    ...
    public static final class b extends x.a implements p0 {
        ...
        public b x(h hVar) {
            q();
            ((a) this.f7278f).U(hVar);
            return this;
        }

        public b z(c cVar) {
            q();
            ((a) this.f7278f).V(cVar);
            return this;
        }

        /* synthetic */ b(C0145a aVar) {
            this();
        }
    }
    ...
    public static a T(h hVar, p pVar) {
        return (a) x.D(DEFAULT_INSTANCE, hVar, pVar);
    }
    ...
    public final Object s(x.d dVar, Object obj, Object obj2) {
        switch (C0145a.f11355a[dVar.ordinal()]) {
            case 1:
                return new a();
            case 2:
                return new b((C0145a) null);
            case 3:
