...
public final class b extends RecyclerView.h {
    ...
    private final AddDrivingSchoolActivity f11587d;

    /* renamed from: e  reason: collision with root package name */
    private final ArrayList f11588e;
    ...
    public static final class a extends RecyclerView.d0 {
        ...
        private final TextView f11590y;

        /* renamed from: z  reason: collision with root package name */
        private final TextView f11591z;
    ...
    public b(AddDrivingSchoolActivity addDrivingSchoolActivity, ArrayList arrayList, c cVar) {
        l.f(addDrivingSchoolActivity, "context");
        l.f(arrayList, "list");
        l.f(cVar, "langSession");
        this.f11587d = addDrivingSchoolActivity;
    ...
    public void p(a aVar, int i10) {
        l.f(aVar, "holder");
        Object obj = this.f11588e.get(i10);
        l.e(obj, "get(...)");
        DrivingSchoolDetRequestModal drivingSchoolDetRequestModal = (DrivingSchoolDetRequestModal) obj;
        aVar.V().setText(this.f11589f.b("enrollment_no", this.f11587d.getString(R.string.enrollment_no)));
        aVar.T().setText(this.f11589f.b("enrollement_date", this.f11587d.getString(R.string.enrollment_date)));
        aVar.Q().setText(this.f11589f.b("certificate_no", this.f11587d.getString(R.string.certificate_no)));
        aVar.O().setText(this.f11589f.b("certificate_date", this.f11587d.getString(R.string.certificate_date)));
        aVar.X().setText(this.f11589f.b("trained_from", this.f11587d.getString(R.string.trained_from)));
        aVar.Z().setText(this.f11589f.b("trained_to", this.f11587d.getString(R.string.trained_to)));
