...
public final class d {
    ...
    private final Shader f2318a;

    /* renamed from: b  reason: collision with root package name */
    private final ColorStateList f2319b;
    ...
    public boolean i() {
        /*
            r1 = this;
            android.graphics.Shader r0 = r1.f2318a
            if (r0 != 0) goto L_0x0010
            android.content.res.ColorStateList r0 = r1.f2319b
            if (r0 == 0) goto L_0x0010
    ...
    public boolean j(int[] iArr) {
        if (i()) {
            ColorStateList colorStateList = this.f2319b;
            int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
            if (colorForState != this.f2320c) {
                this.f2320c = colorForState;
                return true;
            }
        }
        return false;
